    ...
    public class MyBot : IChessBot
    {
        ...
        (ulong, Move, int, int, int)[] TTtable= new (ulong, Move, int, int, int)[0x400000];
            ...
            public Move Think(Board board, Timer timer)
            {
                ...
                int staticEvalPos()
                {
                    int middlegame = 0, endgame = 0, gamephase = 0, sideToMove = 2, square;
